...
export function TrapWarning() {
  ...
  if (traps.length === 0) {
    return (
      <div className='rounded border border-editor-border bg-editor-panel p-3 text-xs text-zinc-300'>
        No trap segments.
      </div>
    )
  }
  ...
  return (
    <div className='rounded border border-red-700 bg-red-950/30 p-3'>
      <div className='text-sm font-semibold text-red-300'>⚠ Trap Segments: {traps.length}</div>
